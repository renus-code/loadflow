  ...
  return (
    <div className="container-fluid px-0 animate-fade-in" style={{ maxWidth: "1600px" }}>
                              ...
                              <div className="d-flex align-items-center justify-content-center gap-2">
                                {n.link && (
                                  <Link
                                    ...
                                    style={{ fontSize: '0.75rem', height: '32px', minWidth: '70px' }}
              ...
              <div className="d-lg-none px-3">
                {loading ? (
                  <div className="text-center py-5 opacity-50">
                    <div className="spinner-grow text-emerald mb-4" role="status"></div>
                    <p className="fw-black text-uppercase tracking-widest small text-white">Updating...</p>
                  </div>
                ) : (
                  <>
                    {filteredNotifications.length === 0 ? (
                      <div className="text-center py-5">
                        ...
                        <p className="text-white opacity-40 fw-medium">No notifications yet.</p>
                      </div>
                    ) : (
                          ...
                          return (
                            ...
                            >
                              <div className="d-flex justify-content-between align-items-start mb-2">
                                <span className="fw-black text-uppercase tracking-widest text-white opacity-40" style={{ fontSize: '0.6rem' }}>
                                  {new Date(n.createdAt).toLocaleDateString(undefined, { 
                                    month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' 
                                  })}
                                </span>
                                {!n.isRead && (
                                  <span className="badge rounded-pill bg-emerald text-dark fw-black p-1 px-2" style={{ fontSize: '0.55rem' }}>UNREAD</span>
                                )}
                              </div>
                              
                              <h4 className={`fs-5 fw-black text-white mb-1 ${!n.isRead ? "text-glow-emerald" : "opacity-80"}`} style={{ lineHeight: '1.2' }}>
                                {title}
                              </h4>
                              {subtitle && (
                                <p className="small text-white opacity-50 mb-4 fw-medium" style={{ lineHeight: '1.4' }}>
                                  {subtitle}
                                </p>
                              )}
                              ...
                              <div className="d-flex gap-2">
                                {n.link && (
                                  <Link
                                    ...
                                    style={{ fontSize: '0.7rem', letterSpacing: '1px', background: '#f59e0b', border: 'none' }}
                                    onClick={() => markAsRead(n._id)}
                                  >
                                    VIEW
                                  </Link>
                                ...
                                <button
                                  ...
                                  style={{ fontSize: '0.7rem', letterSpacing: '1px', background: '#dc2626', border: 'none' }}
                                >
                                  DELETE
                                </button>
                              </div>
      ...
      <style jsx>{`
        ...
        .unread-card { border-left-color: #2bdd66 !important; }
        .shadow-emerald-subtle { box-shadow: 0 10px 30px -10px rgba(45, 221, 102, 0.2); }
        .op-70 { opacity: 0.7; }

        @keyframes pulse-emerald {
          0% { box-shadow: 0 0 0 0 rgba(45, 221, 102, 0.4); }
          70% { box-shadow: 0 0 0 10px rgba(45, 221, 102, 0); }
          100% { box-shadow: 0 0 0 0 rgba(45, 221, 102, 0); }
        }
