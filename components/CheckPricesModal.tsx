  ...
  const steps = [
    {
      progress: 0,
      title:
        "We can definitely help with that! How many vehicles or assets do you have?",
      field: "assetTier",
    },
    {
      progress: 40,
    ...
    {
      progress: 85,
      title: "Finally, what's your phone number?",
      field: "phone",
    },
  ];
  ...
  const renderCurrentStep = () => {
          ...
          {tiers.map((tier) => (
            <button
              ...
              style={{
                ...
                maxWidth: "380px",
                transform:
                  formValues.assetTier === tier ? "scale(1.02)" : "scale(1)",
              }}
            >
              <span
                className={`fw-medium fs-6 ${formValues.assetTier === tier ? "text-success" : ""}`}
              >
                {tier}
              </span>
              {formValues.assetTier === tier && (
                <i
                  className="bi bi-check-circle-fill text-success position-absolute top-50 translate-middle-y animate-fade-in"
                  style={{ right: "20px" }}
                ></i>
              )}
            </button>
    ...
    if (step === 1) {
      ...
      return (
        <div className="w-100 d-flex flex-column align-items-center position-relative mt-2 z-1">
          <div
            className="position-relative w-100 focus-within-ring rounded-3"
          ...
          >
            ...
            {isEmailValid && (
              <i
                className="bi bi-check-circle-fill text-success position-absolute top-50 translate-middle-y animate-fade-in drop-shadow"
                style={{
                  right: "18px",
                  fontSize: "1.3rem",
                  filter: "drop-shadow(0 0 8px rgba(43,221,102,0.4))",
                }}
              ></i>
            )}
          </div>
          {errors.email && (
            <span
              className="text-danger mt-2 text-start w-100 fw-medium"
    ...
    if (step === 4) {
      ...
      return (
        <div className="w-100 d-flex flex-column align-items-center mt-2 z-1">
          <div
            className="position-relative w-100 d-flex align-items-center rounded-3 premium-input focus-within-ring"
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: "400px",
              background:
                "radial-gradient(circle, rgba(43,221,102,0.08) 0%, rgba(0,0,0,0) 70%)",
              top: "-150px",
              right: "-100px",
              pointerEvents: "none",
            }}
          ...
          <button
            type="button"
            className="btn-close btn-close-white position-absolute top-0 end-0 mt-4 me-4 z-3"
          ...
          {submitSuccess ? (
            <div className="modal-body d-flex flex-column align-items-center justify-content-center p-5 text-center h-100 animate-slide-up z-1">
              <div className="position-relative">
                <i
                  ...
                  style={{
                    fontSize: "5rem",
                    filter: "drop-shadow(0 0 30px rgba(43,221,102,0.6))",
                  }}
                ></i>
              </div>
              <h2
              ...
              <p
                className="text-white text-opacity-75 mt-3 fs-5"
                style={{ maxWidth: "450px", lineHeight: 1.6 }}
              >
                We have securely logged your request. A tailored enterprise
                pricing proposal will be transmitted to{" "}
                <strong className="text-white">{formValues.email}</strong>{" "}
                shortly.
              </p>
              <button
                type="button"
                className="btn btn-outline-light px-5 py-3 mt-4 rounded-pill text-white transition-all fw-bold"
                data-bs-dismiss="modal"
              >
                Acknowledge
              </button>
            ...
            <div className="modal-body p-4 p-md-5 d-flex flex-column align-items-center justify-content-center z-1 position-relative">
              ...
              <div
                className="d-flex align-items-center gap-3 w-100 mb-5"
              ...
              >
                ...
                <div
                  className="progress-premium-wrapper flex-grow-1"
                  style={{ height: "14px" }}
                >
                  <div
                    ...
                    style={{
                      ...
                      background:
                        "linear-gradient(90deg, #3b82f6 0%, #2bdd66 100%)",
                      boxShadow: "0 0 10px rgba(43,221,102,0.4)",
                    }}
                  ></div>
                </div>
              </div>
              ...
              {/* Title */}
              <h3
                className="text-center text-white mb-4 fw-normal w-100 px-3 animate-fade-in"
                style={{
                  fontSize: "1.45rem",
                  letterSpacing: "0.2px",
                  lineHeight: 1.5,
              ...
              >
                {submitError && (
                  <div
                    className="alert bg-danger bg-opacity-10 border-danger border border-opacity-25 w-100 text-center py-2 mb-4 rounded-3 fw-medium text-danger"
                ...
                <div
                  className="w-100 d-flex justify-content-center animate-slide-up"
                  key={`step-${step}`}
                >
                  {renderCurrentStep()}
                </div>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        boxShadow:
                          isNextDisabled() || isSubmitting
                            ? "none"
                            : "0 4px 20px rgba(43,221,102,0.4)",
                      }}
                    >
                      {isSubmitting ? (
                        <span
