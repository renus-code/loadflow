...
export default function DispatchTable({
  ...
  return (
    <div className="table-responsive rounded-4 overflow-hidden glass-card-stitch shadow-2xl" style={{ border: '1px solid rgba(255,255,255,0.12)' }}>
      <table className="table table-hover align-middle mb-0 custom-table">
        <thead className="bg-dark bg-opacity-95">
          <tr className="border-0 text-uppercase fw-black" style={{ color: 'rgba(255,255,255,0.85)', letterSpacing: '0.12em', fontSize: '11px' }}>
            ...
            <th className="py-3 px-4 cursor-pointer border-0 header-text" onClick={() => handleSort('driver')}>
