        ...
        <div className="collapse navbar-collapse justify-content-between" id="navbarNav">
          <ul className="navbar-nav mx-auto gap-1 gap-lg-3">
            <li className="nav-item">
              <Link href="/#features" className={`nav-link fw-bold px-4 py-2 nav-pill-hover ${isScrolled ? 'text-dark scrolled-hover' : 'text-white'}`} style={isScrolled ? {} : { textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>Features</Link>
            </li>
            <li className="nav-item">
              <Link href="/#solutions" className={`nav-link fw-bold px-4 py-2 nav-pill-hover ${isScrolled ? 'text-dark scrolled-hover' : 'text-white'}`} style={isScrolled ? {} : { textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>Solutions</Link>
            </li>
            <li className="nav-item">
              <Link href="/#pricing" className={`nav-link fw-bold px-4 py-2 nav-pill-hover ${isScrolled ? 'text-dark scrolled-hover' : 'text-white'}`} style={isScrolled ? {} : { textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>Pricing</Link>
            </li>
          </ul>
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center gap-3 mt-4 mt-lg-0">
            ...
            <Link href="/register" className={`btn fw-black px-4 py-2 rounded-pill shadow-success-glow border-0 hover-zoom d-flex align-items-center justify-content-center gap-2`} style={{ backgroundColor: '#2bdd66', color: '#05070a' }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
