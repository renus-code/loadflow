  ...
  return (
    <>
      <div className="card border-0 shadow-lg rounded-5 overflow-hidden glass-card animate-slide-up">
        ...
        >
          ...
          <div className="d-flex flex-column flex-md-row align-items-stretch align-items-md-center gap-3 ms-auto w-100 w-md-auto mt-3 mt-md-0">
            {/* COMPACT SEARCH */}
            <div
              className="glass-card-stitch p-1 rounded-pill d-flex align-items-center border border-white border-opacity-10 shadow-lg flex-grow-1"
              style={{
                maxWidth: "100%",
                minWidth: "220px",
      ...
      <style jsx>{`
        ...
        .custom-scrollbar.no-scrollbar-y::-webkit-scrollbar {
          height: 4px;
        }
      `}</style>
    </>
